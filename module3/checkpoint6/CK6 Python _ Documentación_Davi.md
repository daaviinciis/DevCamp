# CK6 Python \_ Documentación\_Davi

**BOTTEGA UNIVERSITY**

![bottega university](<../../.gitbook/assets/image0 (1).png>)

## **DOCUMENTACIÓN DE PYTHON PARA PRINCIPIANTES**

### **ÍNDICE**

[**INTRODUCCIÓN**](<CK6 Python _ Documentación_Davi.md#introducción>)

[**1. ¿PARA QUÉ USAMOS CLASES EN PYTHON? 4**](<CK6 Python _ Documentación_Davi.md#1.-¿para-qué-usamos-clases-en-python?>)

[**2. ¿QUÉ MÉTODO SE EJECUTA AUTOMÁTICAMENTE CUANDO SE CREA UNA INSTANCIA DE UNA CLASE? 5**](<CK6 Python _ Documentación_Davi.md#2.-¿qué-método-se-ejecuta-automáticamente-cuando-se-crea-una-instancia-de-una-clase?>)

[**3. ¿CUÁLES SON LOS TRES VERBOS DE API? 6**](<CK6 Python _ Documentación_Davi.md#3.-¿cuáles-son-los-tres-verbos-de-api?>)

[**4. ¿ES MONGODB UNA BASE DE DATOS SQL O NOSQL? 7**](<CK6 Python _ Documentación_Davi.md#4.-¿es-mongodb-una-base-de-datos-sql-o-nosql?>)

[**5. ¿QUÉ ES UNA API? 8**](<CK6 Python _ Documentación_Davi.md#5.-¿qué-es-una-api?>)

[**6. ¿QUÉ ES POSTMAN? 9**](<CK6 Python _ Documentación_Davi.md#6.-¿qué-es-postman?>)

[**7. ¿QUÉ ES EL POLIMORFISMO? 10**](<CK6 Python _ Documentación_Davi.md#7.-¿qué-es-el-polimorfismo?>)

[**8. ¿QUÉ ES UN MÉTODO DUNDER? 11**](<CK6 Python _ Documentación_Davi.md#8.-¿qué-es-un-método-dunder?>)

[**9. ¿QUÉ ES UN DECORADOR DE PYTHON? 12**](<CK6 Python _ Documentación_Davi.md#9.-¿qué-es-un-decorador-de-python?>)
...
## **1. ¿PARA QUÉ USAMOS CLASES EN PYTHON?** <a href="#id-1.-para-que-usamos-clases-en-python" id="id-1.-para-que-usamos-clases-en-python"></a>
...
## **2. ¿QUÉ MÉTODO SE EJECUTA AUTOMÁTICAMENTE CUANDO SE CREA UNA INSTANCIA DE UNA CLASE?** <a href="#id-2.-que-metodo-se-ejecuta-automaticamente-cuando-se-crea-una-instancia-de-una-clase" id="id-2.-que-metodo-se-ejecuta-automaticamente-cuando-se-crea-una-instancia-de-una-clase"></a>
...
## **3. ¿CUÁLES SON LOS TRES VERBOS DE API?** <a href="#id-3.-cuales-son-los-tres-verbos-de-api" id="id-3.-cuales-son-los-tres-verbos-de-api"></a>
...
## **4. ¿ES MONGODB UNA BASE DE DATOS SQL O NOSQL?** <a href="#id-4.-es-mongodb-una-base-de-datos-sql-o-nosql" id="id-4.-es-mongodb-una-base-de-datos-sql-o-nosql"></a>
...
## **5. ¿QUÉ ES UNA API?** <a href="#id-5.-que-es-una-api" id="id-5.-que-es-una-api"></a>
...
## **6. ¿QUÉ ES POSTMAN?** <a href="#id-6.-que-es-postman" id="id-6.-que-es-postman"></a>
...
_// Test: verificar que el código de estado es 200_\
&#xNAN;_&#x70;m.test('Estado es 200', function() {_\
&#xNAN;_&#x70;m.response.to.have.status(200);_\
&#xNAN;_});_

_// Test: verificar que la respuesta tiene el campo 'nombre'_\
&#xNAN;_&#x70;m.test('Respuesta tiene campo nombre', function() {_\
&#xNAN;_&#x63;onst datos = pm.response.json();_\
&#xNAN;_&#x70;m.expect(datos).to.have.property('nombre');_\
&#xNAN;_});_

_// Test: verificar que el tiempo de respuesta es menor a 500ms_\
&#xNAN;_&#x70;m.test('Tiempo de respuesta aceptable', function() {_\
&#xNAN;_&#x70;m.expect(pm.response.responseTime).to.be.below(500);_\
&#xNAN;_});_
...
## **7. ¿QUÉ ES EL POLIMORFISMO?** <a href="#id-7.-que-es-el-polimorfismo" id="id-7.-que-es-el-polimorfismo"></a>
...
## **8. ¿QUÉ ES UN MÉTODO DUNDER?** <a href="#id-8.-que-es-un-metodo-dunder" id="id-8.-que-es-un-metodo-dunder"></a>
...
Cuando hacemos _**print(mi\_objeto)**_ sin definir nada, Python muestra algo como _**<\_\_main\_\_.Libro object at 0x7f...>**_, que no es muy útil. Aquí entran en juego los métodos:

* _**\_\_str\_\_**_ define la representación amigable para el usuario, usada por _**print()**_.
* _**\_\_repr\_\_**_ define la representación técnica para el desarrollador, útil para depuración y logs.

![](../../.gitbook/assets/img8.2.png)
...
![](../../.gitbook/assets/img8.5.png)

### **Ejemplo integrador: clase con múltiples dunders**

![](../../.gitbook/assets/img8.6.png)

| 💡 Consejo clave: No es necesario implementar todos los métodos dunder en cada clase. Solo define aquellos que tengan sentido para tu objeto. Si tu clase representa una colección, implementa _\_\_len\_\__, _\_\_getitem\_\__ y _\_\_contains\_\__. Si quieres que sea legible para el usuario, implementa _\_\_str\_\__. Si necesitas sumar objetos, implementa _\_\_add\_\__. Python es flexible: implementa lo que tu clase realmente necesite. |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |

## **9. ¿QUÉ ES UN DECORADOR DE PYTHON?** <a href="#id-9.-que-es-un-decorador-de-python" id="id-9.-que-es-un-decorador-de-python"></a>
